...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.XamarinForms.ChartRenderer.Android.ExtendedChartTooltipBehavior, Telerik.XamarinForms.Chart", ExtendedChartTooltipBehavior.class, __md_methods);
	}
	...
	public ExtendedChartTooltipBehavior (android.content.Context p0)
	{
		...
		if (getClass () == ExtendedChartTooltipBehavior.class)
			mono.android.TypeManager.Activate ("Telerik.XamarinForms.ChartRenderer.Android.ExtendedChartTooltipBehavior, Telerik.XamarinForms.Chart", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
